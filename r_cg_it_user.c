...
//void	IR_recieve_timeout(void);
//void	TaiSEIA_recieve_timeout(void);
...
void	UART0_recieve_timeout(void);
void	UART1_recieve_timeout(void);
void	UART2_recieve_timeout(void);
...
static void __near r_it_interrupt(void)
{
	...
	UART0_recieve_timeout();
	UART1_recieve_timeout();
	UART2_recieve_timeout();
//	buzzer_control();
	LED_display();
	Check_themometer();
	timer_counter_down();
