...
#if 0
extern	uint8_t	LCD_Data_timeout_prot,UART2_RxBuff_conter;
extern	uint8_t	LCD_Data_recieve_timeout_timer;
/*copy this in interrupt receive after code generate
	UART2_RxBuff_conter++;
	LCD_Data_timeout_prot = SET;//setup receive timeout job
	LCD_Data_recieve_timeout_timer = 0;//clear timeout timer if any interrupt occur
*/
void	check_recieved_data(void);
void	R_LCD_receive_start(void);
extern	uint8_t	TaiSEIA_Data_timeout_prot,UART0_RxBuff_conter,UART0_RxBuff[30];
extern	uint8_t	TaiSEIA_Data_recieve_timeout_timer;
/*copy this in interrupt receive after code generate
	UART0_RxBuff_conter++;
	TaiSEIA_Data_timeout_prot = SET;//setup receive timeout job
	TaiSEIA_Data_recieve_timeout_timer = 0;//clear timeout timer if any interrupt occur
*/
void	R_TaiSEIA_receive_start(void);
void	R_TaiSEIA_receive_end(void);
extern	uint8_t	UART1_Data_timeout_prot,UART1_RxBuff_conter;
extern	uint8_t	UART1_Data_recieve_timeout_timer;
/*copy this in interrupt receive after code generate
	UART1_RxBuff_conter++;
	UART1_Data_timeout_prot = SET;//setup receive timeout job
	UART1_Data_recieve_timeout_timer = 0;//clear timeout timer if any interrupt occur
*/
#endif
...
{
    /* Start user code. Do not edit comment generated here */
    com_status = 2U;                    /* Communication is abnormal end. */
    /* End user code. Do not edit comment generated here */
}
...
static void r_iica0_callback_master_receiveend(void)
{
    SPT0 = 1U;
    /* Start user code. Do not edit comment generated here */
    com_status = 0U;                    /* Communication is normal end. */
    /* End user code. Do not edit comment generated here */
}
